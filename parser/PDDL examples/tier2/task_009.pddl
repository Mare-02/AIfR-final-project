(define (problem task_009)
  (:domain lego)

  (:objects
    brick_1_4x2 brick_2_2x2 brick_3_2x2 brick_4_4x2 - brick
  )
  ...
  (:init
    ...
    (on_table brick_4_4x2)
    (clear brick_4_4x2)
    (pick_area brick_4_4x2)
    (hand_empty)
  )
